...
export const editorHelpSections: HelpSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { term: "blend", description: "Режим наложения: normal, add, multiply, screen. По умолчанию normal." },
      { term: "z", description: "Порядок отрисовки: 0 — под часами, 1+ — над. По умолчанию 0." },
